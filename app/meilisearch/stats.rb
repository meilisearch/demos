...
def stats(array)
  ...
  stats_on_download_number(sorted, 500000)
  stats_on_download_number(sorted, 1000000)
  stats_on_download_number(sorted, 2000000)
  stats_on_download_number(sorted, 3000000)
  stats_on_download_number(sorted, 5000000)
  stats_on_download_number(sorted, 10000000)
  stats_on_download_number(sorted, 20000000)
  stats_on_download_number(sorted, 30000000)
  stats_on_download_number(sorted, 50000000)
end
